...
- Ambient type declarations (`.d.ts`) for the Ragic Workflow runtime objects
- Commonly used Ragic workflow APIs and structures (as covered by the [official documentation](https://www.ragic.com/intl/en/doc/15/javascript-workflow-engine))

> Note: Ragic’s runtime environment is not a standard Node.js/browser runtime.

## Installation

```bash
npm install -D types-ragic-workflow
# or
yarn add -D types-ragic-workflow
# or
